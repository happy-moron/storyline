ComfyUI is an image-generation server which can be used to create images based on prompts.

It uses JSON-defined workflow/pipeline files which control all the details of the backing image-gen model.

The server runs under the user 'comfyui' systemctl service

systemctl --user start comfyui

and it runs on a local port

http://127.0.0.1:8188

A sample invocation of a pipeline is (taken from https://github.com/Comfy-Org/ComfyUI/blob/master/script_examples/basic_api_example.py )
